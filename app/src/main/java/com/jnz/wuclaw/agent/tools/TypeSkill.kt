...
class TypeSkill(private val context: Context) : Skill {
    ...
    override val description: String
        get() {
            val isAccessibilityEnabled = com.jnz.wuclaw.accessibility.AccessibilityProxy.isConnected.value == true &&
                                        com.jnz.wuclaw.accessibility.AccessibilityProxy.isServiceReady()
            val statusNote = when {
