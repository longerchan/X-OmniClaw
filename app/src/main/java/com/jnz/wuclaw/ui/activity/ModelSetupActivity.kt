...
import com.jnz.wuclaw.databinding.ActivityModelSetupBinding
import com.jnz.wuclaw.config.ConfigLoader
import com.jnz.wuclaw.config.ModelDefinition
import com.jnz.wuclaw.config.ModelsConfig
...
class ModelSetupActivity : AppCompatActivity() {
    ...
    private fun saveAndFinish() {
        ...
        val apiKey = if (userInputKey.isNullOrEmpty()) {
            val builtInKey = com.jnz.wuclaw.config.BuiltInKeyProvider.getKey()
        ...
        try {
            ...
            val modelSelection = com.jnz.wuclaw.config.ModelSelectionConfig(primary = defaultModelId)
            val existingAgents = config.agents ?: com.jnz.wuclaw.config.AgentsConfig()
