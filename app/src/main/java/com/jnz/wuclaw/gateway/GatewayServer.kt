    ...
    inner class GatewayWebSocket(
        ...
        private fun handleSessionsHistory(params: JSONObject?): JSONObject {
            ...
            try {
                ...
                val sessionManager = com.jnz.wuclaw.core.MainEntryNew.getSessionManager()
        ...
        private fun handleChatSend(params: JSONObject?): JSONObject {
            ...
            val adbCommand = if (sessionId.isNotEmpty()) {
                "adb shell am broadcast -a com.jnz.wuclaw.ACTION_EXECUTE_AGENT --es message \"$message\" --es sessionId \"$sessionId\""
            } else {
                "adb shell am broadcast -a com.jnz.wuclaw.ACTION_EXECUTE_AGENT --es message \"$message\""
            }
            ...
            try {
                ...
                val intent = android.content.Intent("com.jnz.wuclaw.ACTION_EXECUTE_AGENT").apply {
