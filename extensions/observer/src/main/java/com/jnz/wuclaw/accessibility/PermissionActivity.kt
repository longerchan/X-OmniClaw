...
import com.jnz.wuclaw.accessibility.databinding.ActivityObserverPermissionsBinding
...
class PermissionActivity : Activity() {
    ...
    private fun isAccessibilityServiceEnabled(): Boolean {
        return try {
            ...
            val serviceFull = "${packageName}/com.jnz.wuclaw.accessibility.service.PhoneAccessibilityService"
